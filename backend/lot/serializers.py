...
class LotNestedSerializer(serializers.ModelSerializer):
    ...
    update_frequency = serializers.DurationField(source='auction.update_frequency', allow_null=True, required=False)
    bid_step = serializers.DecimalField(source='auction.bid_step', allow_null=True,required=False, max_digits=8, decimal_places=2)
